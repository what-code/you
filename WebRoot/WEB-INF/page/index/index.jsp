...
<body>
    ...
    <div class="wp mt20 you-hot">
        ...
        <div class="you-hot-city">
            <ul class="cfx">
               	<c:forEach var="hc" items="${hotCity}" varStatus="status">
	                <li ${status.count % 6 == 0 ?'class="last"':''}>
	                    <a target="_blank" href="${hc.cityUrl }">
	                        <img src="${hc.imageUrl }" alt="" title="" width="131" height="131" onerror="this.src='${rootPath }/images/you/120x76.jpg';"/>
	                        <span class="c1">${hc.cityName }</span>
	                    </a>
	                </li>
            	</c:forEach>
            </ul>
    ...
    <div class="wp mt20 you-hot">
        ...
        <div class="you-hot-type cfx">
        	<c:forEach  var="ht" items="${hotTravle}" varStatus="status">
          		<a target="_blank" href="${ht.cityUrl }" ${status.count == 1 ? "class='fl'" : "class='fr'"}>
	                <img src="${ht.imageUrl }" alt="" title=""  onerror="this.src='${rootPath }/images/you/120x76.jpg';"/>
	                <span class="c-pink">${ht.cityName }</span>
	            </a>
            </c:forEach>
        </div>
    </div>
                	...
                	<c:forEach var="t" items="${travel}" varStatus="status">
	                    <li>
	                        <a href="${rootPath }/detail_0_${t.id }.html" target="_blank" title="${t.name }">
	                            <img src="${t.imgurl }" alt="" title="" width="171" height="108" onerror="this.src='${rootPath }/images/you/120x76.jpg';"/>
	                            <span><!-- <i class="iplace">延边</i> --><i class="iprice">￥${t.salesPrice }</i></span>
	                        </a>
	                        <p><a href="${rootPath }/detail_0_${t.id }.html" title="${t.name }">${t.name }</a></p>
	                    </li>
                	</c:forEach>
                </ul>
            </div>
    ...
    <div class="wp mt20 floor-you-hotel cfx">
        <div class="you-list-box fl">
            ...
            <div class="hotel-list-wrap">
                <ul class="hotel-list">
                	<c:forEach var="h" items="${hotel}" varStatus="status">
	                    <li>
	                        <a href="${rootPath }/detail_1_${h.id }.html" class="hotel-img fl" target="_blank" title="${h.name }">
	                        	<img src="${h.imgurl }" alt="" title="" width="120" height="76" onerror="this.src='${rootPath }/images/you/120x76.jpg';"/>
	                        </a>
	                        <div class="hotel-info fr">
	                            <h6><a href="${rootPath }/detail_1_${h.id }.html" title="${h.name }">${h.name }</a></h6>
	                            <p class="hotel-star"><i class="star"><i class="star-inner" style="width:${h.levelInfo*20 }%;"></i></i></p>
	                            <p class="hotel-address"><a href="${rootPath }/detail_1_${h.id }.html" target="_blank">${h.district }</a></p>
<%-- 	                            <p class="hotel-num"><span class="hotel-score">${h.score }</span>分</p> --%>
	                            <span class="pos-price">￥<em>${h.salesPrice }</em>起</span>
	                        </div>
	                    </li>
                    </c:forEach>
                </ul>
