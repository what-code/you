	...
	<div class="nav">
		<div class="panel">
			<ul class="cf f-yh">
				...
				<li  ${curPageTag=="flight" ? "class=\"cur nob\"":"last"}><a href="${rootPath}/flight.html">机票</a></li>
				<li ${curPageTag=="train" ? "class=\"cur nob\"":" "}><a href="${rootPath}/train.html">火车票</a></li>
				<li class="last"><a href="http://www.qiantuan.com" target="_blank">特惠境外游</a></li> --%>
                ...
                <li ${pageTag == "1" ? "class=\"nob cur\"" : ""}><a href="${rootPath}/list_1_-1_1.html">酒店</a></li>
                <li ${pageTag == "2" ? "class=\"nob cur\"" : ""}><a href="${rootPath}/list_2_-1_1.html">攻略</a></li>
                <li ${pageTag == "3" ? "class=\"nob cur\"" : ""}><a href="${rootPath}/flight.html">机票</a></li>
                <li ${pageTag == "4" ? "class=\"nob cur\"" : ""}><a href="${rootPath}/train.html">火车票</a></li>
                <li class="last"><a href="http://www.qiantuan.com" target="_blank">特惠境外游</a></li>
			</ul>
		</div>
	</div>
...
<c:if
	test="${curPageTag!='flight' && curPageTag!='train' && curPageTag!='sitemap' && curPageTag!='noNoteResult' && curPageTag!='domesticTravel'&&curPageTag!='abroadTravel'&&curPageTag!='peripheryTravel'&&curPageTag!='hotel'&&curPageTag!='noResult'&&curPageTag!=''&&curPageTag!='notes'&&curPageTag!=null}">
	<!-- 帮5游搜索 -->
